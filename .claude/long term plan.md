...
## Active: 2026 Startup Auction
- [x] Identify league and draft via Sleeper API
- [x] Calculate 3-year PPG rankings under NFZ scoring
...
## Future leagues
- [ ] Add second league directory when Ryan joins/creates another league
